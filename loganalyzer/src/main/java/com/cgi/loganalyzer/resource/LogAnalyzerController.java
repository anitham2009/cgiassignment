...
public class LogAnalyzerController {
	...
	/**
	 * Handle LogAnalyzerServiceException
	 * 
	 * @param ex LogAnalyzerServiceException
	 * @return ErrorResponse
	 */
	@ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
	@ExceptionHandler(LogAnalyzerServiceException.class)
	public ErrorResponse handleServiceException(LogAnalyzerServiceException ex) {
		ErrorResponse errorResponse = ErrorResponse.builder().errorMessage(ex.getMessage())
